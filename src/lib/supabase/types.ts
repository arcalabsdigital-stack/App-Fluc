...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      categories_backup_20260825: {
        Row: {
          accounting_group: string | null
          created_at: string | null
          efeito_caixa: string | null
          grupo: string | null
          id: string | null
    ...
    Functions: {
      apply_coupon_to_organization: {
        Args: { p_coupon_code: string; p_org_id: string }
        Returns: Json
      }
      ...
      fn_resumo_periodo: {
        ...
        Returns: {
          ...
          qtd_sem_categoria: number
          receitas: number
          resultado: number
          saidas_caixa: number
          valor_sem_categoria: number
        }[]
      }
      fn_saldo_contas: {
        Args: never
