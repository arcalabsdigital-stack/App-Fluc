DO $DO_BLOCK$
BEGIN
  -- Optional block if we needed procedural wrapping
END $DO_BLOCK$;
...
BEGIN
  ...
  RETURN json_build_object(
    'totalBalance', v_realized_balance, -- fallback wrapper
    ...
    'monthIncome', v_month_income_realized, -- fallback wrapper
    'monthExpense', v_month_expense_realized, -- fallback wrapper
